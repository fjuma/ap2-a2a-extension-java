...
public interface ShopperAgent {

    /**
     * Helps the user shop for products.
     *
     * @param assignment the task assignment for shopping
     * @return the result of the shopping process
     */
    @SystemMessage("""
        ...
        3. After you have gathered what you believe is sufficient information,
          use the 'createIntentMandate' tool with the collected information
        ...
        5. Once the user confirms, use the 'findProducts' tool. It will
        ...
        8. After they choose, call the updateChosenCartMandate tool with the
          appropriate cart ID.
    ...
    String shopForProducts(String assignment);
}
